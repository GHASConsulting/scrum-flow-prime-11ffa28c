        ...
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            ...
            <div className="flex border-b">
              <div className="w-48 min-w-48 p-2 font-medium border-r bg-muted">
                <p>Tarefa</p>
              </div>
              <div className="flex-1 flex">
                {dayRange.map((day, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`flex-1 min-w-[30px] text-center text-xs p-1 border-r ${isCurrentDay ? 'bg-primary/20 font-bold' : ''}`}
                    >
            ...
            {tasks.map((task) => {
              ...
              return (
                <div key={task.id} className="flex border-b hover:bg-muted/50">
                  <div className="w-48 min-w-48 p-2 border-r truncate" title={task.name}>
                    {task.name}
                  </div>
